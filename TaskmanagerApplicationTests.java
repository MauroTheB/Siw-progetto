...
class TaskmanagerApplicationTests {
	...
	void testUpdateUser() {
		...
		User user1Update = new User("mariarossi", "password", "mario", "rossi");
		...
		List<Project> projectVsibleByUser2 = projectRepository.findByMembers(user2);
		assertEquals(projectVsibleByUser2.size(), 1);
		assertEquals(projectVsibleByUser2.get(0), project1);
